...
class Vertex
{
    ...
    public:
        ...
        Vertex (double value=0, VertexInterface *interface=nullptr, std::string name="") :
        m_value(value), m_interface(interface), m_name(name)  {  }
...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetBox m_bt_box;

        grman::WidgetButton m_bouton_retour;
        grman::WidgetImage m_bouton_retour_image;

        grman::WidgetButton m_bouton_charger;
        grman::WidgetImage m_bouton_charger_image;

        grman::WidgetButton m_bouton_sauver;
        grman::WidgetImage m_bouton_sauver_image;
...
class Graph
{
    ...
    public:
        ...
        void charger(std::string fichier_name);
        void charger_inter();
        void sauver(std::string fichier_name);
        void ajouter_sommet();
        ...
        void update(bool& menu_state, bool& maj,  bool& chaine1_ok, bool& chaine2_ok, bool& chaine3_ok);
};
