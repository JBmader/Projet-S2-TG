...
void Graph::chaine1()
{
    ...
    add_interfaced_vertex(1, 60.0, 400, 100, "ours.jpg");
    ...
    add_interfaced_edge(2, 1, 2, 50.0);
    add_interfaced_edge(3, 1, 3, 50.0);
    add_interfaced_edge(4, 2, 3, 50.0);


}

/// La méthode update à appeler dans la boucle de jeu pour les graphes avec interface
void Graph::update(bool& menu_state, bool &maj)
{
    if (!m_interface)
        return;
