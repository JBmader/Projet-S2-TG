...
GraphInterface::GraphInterface(int x, int y, int w, int h)
{
    ...
    m_text_bt_supprimer_vertex.set_dim(75,15);
    m_text_bt_supprimer_vertex.set_gravity_xy(grman::GravityX::Right, grman::GravityY::Center);
    m_text_bt_supprimer_vertex.set_bg_color(BLANC);
    m_text_bt_supprimer_vertex.set_message("Supp Vertx");

    m_tool_box.add_child(m_bt_supprimer_vertex);
    m_bt_supprimer_vertex.set_dim(75,15);
    m_bt_supprimer_vertex.set_gravity_xy(grman::GravityX::Right, grman::GravityY::Center);
    m_bt_supprimer_vertex.set_bg_color(VERTFLUO);

    ///Bouton supp arc
    m_tool_box.add_child(m_text_bt_supprimer_edge);
    m_text_bt_supprimer_edge.set_dim(75,15);
    ...
    m_text_bt_supprimer_edge.set_message("Sup Sommet");

    m_tool_box.add_child(m_bt_supprimer_edge);
    m_bt_supprimer_edge.set_dim(75,15);
